...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden px-4">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] rounded-full bg-brand-600/20 blur-[100px] pointer-events-none"></div>
      <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] rounded-full bg-indigo-600/20 blur-[100px] pointer-events-none"></div>
      ...
      <div className="w-full max-w-md relative z-10 animate-fade-in">
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-zinc-400">Log in to your DataLens account</p>
        </div>
        ...
        <p className="text-sm text-zinc-500 mt-8 text-center">
          ...
          <Link to="/register" className="text-brand-400 font-medium hover:text-brand-300 hover:underline transition-colors">
            Create an account
          </Link>
        </p>
      </div>
